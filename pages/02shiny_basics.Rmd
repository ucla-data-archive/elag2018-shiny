...
To accomplish this, we'll add a widget that allows a user to select a specific library. Our dataset actually contains data for approximately 90 libraries, but for convenience, we'll limit choices to a predetermined list of the ten libraries.

You can find the code chunk in the project folder in a file named library_select_list.R. Open it then copy and paste the following code to your application immediately preceding the sliderInput function. Be sure to separate the two function calls with a comma.
